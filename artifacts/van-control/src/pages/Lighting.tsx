...
export default function Lighting() {
  const { state, toggleLight, setLightBrightness, toggleLightWarmth, turnAllLightsOff } = useSimulatedData();
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-6 flex-1 overflow-y-auto no-scrollbar pb-10">
        ...
        {/* Placeholder / decorative card to fill the 6th slot in a 3-col grid */}
